...
const ModuleSidebar = ({ trans }: any) => {
  ...
  const [nestedIndex, setNestedIndex] = useState<any>(null);
  const [multiNestedIndex, setMultiNestedIndex] = useState<any>(null);
  // mobile menu overlay
  ...
  const toggleNested = (subIndex: any) => {
  ...
  const toggleMultiNested = (index: any) => {
