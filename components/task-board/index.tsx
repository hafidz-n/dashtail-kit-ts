...
const TaskBoard = ({ boards, tasks, subTasks, comments }: any) => {
  ...
  // for board
  const [selectedBoardId, setSelectedBoardId] = React.useState<any>(null);
  const [selectedBoard, setSelectedBoard] = React.useState<any>(null);
  // for task
  const [selectedTaskId, setSelectedTaskId] = React.useState<any>(null);
  const [selectedTask, setSelectedTask] = React.useState<any>(null);
  const [selectedBoardForTask, setSelectedBoardForTask] = React.useState<any>(null);

  // handler task view
  const taskViewHandler = (value: any) => {
    setTaskView(value);
  };
  // handle create board
  ...
  const handleTaskOpener = (boardId: any) => {
  ...
  // update task handler
  const updateTaskHandler = (task: any) => {
