...
const EventSheet = ({ open, onClose, categories, event, selectedDate }: any) => {
  ...
  const [eventIdToDelete, setEventIdToDelete] = useState<any>(null);
  ...
  const handleOpenDeleteModal = (eventId: any) => {
